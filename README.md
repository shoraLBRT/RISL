# RISL — словарь жестового языка

Веб-словарь: у каждого слова есть определение и видеозапись жеста. Гости ищут и
смотрят, единственный администратор наполняет и правит словарь.
...
Код и содержимое словаря лицензированы по-разному.

- **Код** — [MIT](LICENSE): исходники приложения, разметка страниц, стили и
  скрипты.
- **Содержимое словаря** — [CC BY-SA 4.0](LICENSE-CONTENT): видеозаписи жестов,
  определения слов и названия тем. Используя их, указывайте источник и
  распространяйте производные работы на тех же условиях.

Разделение сделано потому, что Creative Commons не рекомендует свои лицензии
для программ: в них нет условий о патентах и о доступности исходников.
